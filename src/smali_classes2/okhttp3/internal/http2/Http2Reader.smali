...
.method constructor <init>(Lokio/g;Z)V
    ...
    .line 9
    .line 10
    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lokio/g;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 33
    .line 34
    invoke-interface {p1, v1, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILokio/g;I)V

    .line 35
    .line 36
    .line 37
    iget-object p0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/g;
    ...
    .line 40
    invoke-interface {p0, p1, p2}, Lokio/g;->skip(J)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 33
    invoke-interface {p0, v0, v1}, Lokio/g;->K(J)Lokio/h;
...
.method static readMedium(Lokio/g;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
    .end annotation
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 15
    .line 16
    invoke-interface {p0}, Lokio/g;->readInt()I
    ...
    .line 25
    :cond_0
    invoke-interface {p1, p2, p4, p0}, Lokhttp3/internal/http2/Http2Reader$Handler;->ping(ZII)V
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 34
    .line 35
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/g;
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    .line 4
    .line 5
    invoke-interface {v0, v1, v2}, Lokio/g;->G(J)V
    :try_end_0
    ...
    .line 9
    .line 10
    invoke-static {v0}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Lokio/g;)I
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    .line 24
    .line 25
    sget-object p1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lokio/h;
    ...
    .line 63
    :cond_2
    invoke-virtual {p1, p0}, Lokio/h;->equals(Ljava/lang/Object;)Z
